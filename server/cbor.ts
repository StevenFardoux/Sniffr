...
export function encode(value: any): string | Uint8Array {
    ...
    function commitWrite(..._args: any[]): void {
        offset += lastLength;
    }
...
export function decode(data: Uint8Array, tagger?: (value: any, tag?: number) => any, simpleValue?: () => any): any {
    let dataView = new DataView(data.buffer);
    let offset = 0;
    const defaultTagger = (value: any, tag?: number) => value;
    const defaultSimpleValue = () => undefined;
    const finalTagger = typeof tagger === "function" ? tagger : defaultTagger;
    const finalSimpleValue = typeof simpleValue === "function" ? simpleValue : defaultSimpleValue;
    ...
    function decodeItem(): any {
        ...
        switch (majorType) {
            ...
            case 5:
                ...
                return retObject;
            case 6:
                return finalTagger(decodeItem(), length);
            case 7:
                switch (length) {
                    case 20:
                        return false;
